...
function SpecialityCard({ title, description, icon }) {
  return (
    <div
      className="text-white mr-10 border border-gray-700 flex my-6 flex-col items-center px-3 py-4 max-w-[320px] min-w-[290px] rounded-md cursor-pointer transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:bg-gray-800 group"
    >
      {/* Icon */}
