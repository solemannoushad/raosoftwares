  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 my-24">
      ...
      <div className="flex items-center justify-center flex-col relative my-8">
        <Image src="/icons/devstella.svg" className="absolute top-10" alt="Devstella" width={600} height={600} loading="lazy" />
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="bg-zinc-800 p-6 sm:p-8 rounded-2xl w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                  <Image src={`/icons/${service.icon}.svg`} alt="Devstella Services" className="w-12 sm:w-14 md:w-16" width={100} height={100} loading="lazy" />
                </div>
